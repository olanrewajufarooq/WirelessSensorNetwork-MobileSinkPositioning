...
sn_method = 'even_nonconfined'; % the mobile sink can be either selected randomly 'random' or evenly spaceed only initially 'even_nonconfined' or evenly spaced throughout 'even_confined.
...
rounds = 50; % Number of rounds per simulation
...
[SN, round_params, sim_params] = simulation_rounds(rounds, SN, dims, ener, k, ms_ids, n_clusters, mob_params, sn_model, past_data_considered, sn_method);
